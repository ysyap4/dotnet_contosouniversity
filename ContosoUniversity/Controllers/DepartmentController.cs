        ...
        public async Task<ActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            if (TryUpdateModel(departmentToUpdate, fieldsToBind))
            {
                try
                {
                    ...
                    // Then when the Entity Framework creates a SQL UPDATE command, that command will include 
                    // a WHERE clause that looks for a row that has the original RowVersion value.
